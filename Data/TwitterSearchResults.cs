...
namespace Twarp
{
    ...
    public class Status
    {
        ...
        // display properties:
        //public string tweetDetails
        //{
        //    get
        //    {
        //        return "<Bold>" + user.name + "</Bold> @" + user.screen_name + " " + created_at;
        //    }
        //}
        ...
        public string tweetDate
        {
            get
            {
                DateTime date = DateTime.ParseExact(created_at, "ddd MMM dd HH:mm:ss zzz yyyy", CultureInfo.InvariantCulture);
                return date.ToLocalTime().ToString("ddd MMM dd HH:mm:ss zzz yyyy");
            }
        }
    }
